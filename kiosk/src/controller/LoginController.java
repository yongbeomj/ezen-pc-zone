...
public class LoginController implements Initializable {
	...
	//	btnpc_1.setStyle("-fx-background-color: #ff0000; ");
	
	//	buttonss[1].setStyle("-fx-background-color: #ff0000; "); 
		
		System.out.println(buttonss[0]);
	//	buttonss[].setStyle("-fx-background-color: #ff0000; "); 
	}
